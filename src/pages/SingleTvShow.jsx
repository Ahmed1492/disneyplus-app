...
export const SingleTvShow = () => {
  const data = [
    {
      logo: "/singlePage/logo1.svg",
      background: "/singlePage/cover1.png",
      desc: `Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quo magni officia eos voluptas. Dolorum, ipsa aspernatur doloremque expedita consequuntur ducimus, totam necessitatibus sunt nemo id, commodi quibusdam recusandae voluptatum harum!`,
      select: "",
    },
    {
